    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/health", "/api/slots/health", "/actuator/**", "/error").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/slots", "/api/slots/**").hasAnyRole("ADMIN", "DOCTOR")
                        .requestMatchers(HttpMethod.PATCH, "/api/slots/**").hasAnyRole("ADMIN", "DOCTOR")
